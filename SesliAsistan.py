...
class SesliAsistan:
    ...
    def ses_karslik(self,gelen_Ses):
        ...
        elif (gelen_Ses in "ampulü yak"):
            try:
                self.seslendirme("hangi ampulü yakmamı istersiniz")
                cevap = self.mikrofon()
                if (cevap == "birinci"):
                    self.seslendirme("birinci ampulünüzü yakıyorum")
                    ArduinoKodlari.ampul_islemleri(1, 8)
                elif (cevap == "ikinci"):
                    self.seslendirme("ikinci ampulünüzü yakıyorum")
                    ArduinoKodlari.ampul_islemleri(1, 9)
                elif (cevap == "ikisini de"):
                    self.seslendirme("iki ampulü de yakıyorum")
                    ArduinoKodlari.ampul_islemleri(1, 9)
                    ArduinoKodlari.ampul_islemleri(1, 8)
                else:
                    self.seslendirme("dediğiniz komut anlaşılmadı")

            except:
                self.seslendirme("bir hata meydana geldi")

        elif (gelen_Ses in "ampulü söndür"):
            try:
                self.seslendirme("hangi ampulü söndürmemi istersiniz")
                cevap = self.mikrofon()
                if (cevap == "birinci"):
                    self.seslendirme("birinci ampulünüzü söndürüyorum")
                    ArduinoKodlari.ampul_islemleri(0, 8)
                elif (cevap == "ikinci"):
                    self.seslendirme("ikinci ampulünüzü söndürüyorum")
                    ArduinoKodlari.ampul_islemleri(0, 9)
                elif (cevap == "ikisini de"):
                    self.seslendirme("iki ampulü de söndürüyorum")
                    ArduinoKodlari.ampul_islemleri(0, 9)
                    ArduinoKodlari.ampul_islemleri(0, 8)
                else:
                    self.seslendirme("dediğiniz komut anlaşılmadı")
        ...
        elif (gelen_Ses in "klimayı aç"):
            self.seslendirme("hemen açıyorum")
            ArduinoKodlari.klima_islemleri(1, 7)

        elif (gelen_Ses in "klimayı kapat"):
            self.seslendirme("klimanızı hemen kapatıyorum")
            ArduinoKodlari.klima_islemleri(0, 7)
